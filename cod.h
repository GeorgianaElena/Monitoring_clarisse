...
//       }\n\
//     }\n\
//     // printf(\"current_node_degree = %d, pulse = %ld\\n\", current_node_degree, pulse_timestamp);\n\
...
//     int k = 0;\n\
//     while(k < cnt) { \n\
//       a = EVdata_metrics_t(k);\n\
//       if(a->timestamp == pulse_timestamp) {\n\
//         EVdiscard_metrics_t(k);\n\
//       } else { \n\
//         ++k; \n\
//       }\n\
//     }\n\
